...
CATEGORIES = [
    {
        ...
        "query": "resolução ANP Diário Oficial, ASTM nova norma publicada, ASTM standard update",
    },
    {
        "id": "petroleo",
        "label": "Petróleo",
        "query": (
            "petróleo Brasil, produção de petróleo Petrobras, exportação de petróleo Brasil, "
            "ASTM D4007 BSW, ASTM D4928 Karl Fischer, ASTM D4807 sedimentos, "
            "ASTM D3230 salinidade, ASTM D6470 salinidade, UOP 163 H2S, ASTM D1298 densidade API"
        ),
    },
    {
        "id": "claros",
    ...
    },
    {
        ...
        "query": "Petrobras comunicado imprensa, IBP petróleo e gás, leilão ANP rodada de licitação, epbr petróleo",
    },
]
